...
class Trainer():
    ...
    def print_log(self):
        print('G: {g_loss:.2f} | D: {d_loss:.2f} | GP: {last_gp_loss:.2f} | PL: {pl_mean:.2f}'.format(g_loss=self.g_loss, d_loss=self.d_loss, last_gp_loss=self.last_gp_loss, pl_mean=self.pl_mean))
